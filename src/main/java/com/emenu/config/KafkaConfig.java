...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.consumer.group-id:notification-gateway-group}")
    ...
    public ProducerFactory<String, Object> producerFactory() {
        ...
        // Allow larger messages for file uploads (up to 50 MB)
        config.put(ProducerConfig.MAX_REQUEST_SIZE_CONFIG, 52_428_800);
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Object> kafkaListenerContainerFactory() {
        ...
        // Manual acknowledgment so we commit only after successful processing
